...
const Create = () => {
  ...
  return <>
    ...
    <form onSubmit={makePost}>
      <input type='text' style={{ padding: '12px', marginBottom: '20px', fontSize: '16px', width: '400px', border: 'none', borderBottom: '1px solid #ddd', outline: 'none' }} placeholder='Title*' value={title} onChange=
